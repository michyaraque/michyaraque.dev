...
const ClassCard = (props: IClassCard) => {
  ...
  return (
    <section className="flex flex-col gap-4 w-100 shadow-md min-h-[100px] rounded-md p-2 border-2 border-zinc-100 dark:border-zinc-700 dark:bg-zinc-800">
      {data.map(
        (
  ...
  return (
    ...
    >
      <header className="mb-10">
        <span className="inline-block mt-16 mb-8 text-5xl font-bold text-zinc-600 dark:text-zinc-300">
          {courseName}
        </span>
              ...
              <>
                <div key={index} className="flex flex-col gap-3 my-auto mt-0">
                  <div className="flex flex-row flex-grow gap-2 my-auto">
                    <div className="text-white w-10 h-10 rounded-md bg-brand-primary-100 dark:bg-zinc-400 font-bold">
                      <span className="text-center w-full h-full flex items-center justify-center">{moduleNumber}</span>
                    </div>
                    <span className="h-auto my-auto font-bold text-zinc-800 dark:text-zinc-300">
